...
def seeds(request):
    ...
    p.saga=1
    p.save()
    p = character(nm_character="Goku",img_character="https://vignette.wikia.nocookie.net/dragonball/images/5/5b/Gokusteppingoutofaspaceship.jpg/revision/latest/scale-to-width-down/224?cb=20150325220848",fighting_power="924",type_character=2,saga=2)
    p.save()
    p = character(nm_character="Goku Super Sayajin 1",img_character="https://dreager1.files.wordpress.com/2011/08/snap2149516qs7.jpg",fighting_power="150000000",type_character=2,saga=2)
    p.save()
    p = character(nm_character="Goku Super Sayajin 2",img_character="https://vignette.wikia.nocookie.net/dragonball/images/a/ac/Goku-Super-Saiyan-2-.jpg/revision/latest?cb=20110426171840",fighting_power="6000000000",type_character=2,saga=2)
    p.save()
    p = character(nm_character="Goku Super Sayajin 3",img_character="https://vignette2.wikia.nocookie.net/dragonuniverse/images/8/89/SSJ3.png/revision/latest?cb=20160928233848",fighting_power="10000000000",type_character=2,saga=2)
    p.save()
    p = character(nm_character="Goku",img_character="https://vignette.wikia.nocookie.net/dragonball/images/5/5b/Gokusteppingoutofaspaceship.jpg/revision/latest/scale-to-width-down/224?cb=20150325220848",fighting_power="924",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Goku Super Sayajin 1",img_character="https://dreager1.files.wordpress.com/2011/08/snap2149516qs7.jpg",fighting_power="150000000",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Goku Super Sayajin 2",img_character="https://vignette.wikia.nocookie.net/dragonball/images/a/ac/Goku-Super-Saiyan-2-.jpg/revision/latest?cb=20110426171840",fighting_power="6000000000",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Goku Super Sayajin 3",img_character="https://vignette2.wikia.nocookie.net/dragonuniverse/images/8/89/SSJ3.png/revision/latest?cb=20160928233848",fighting_power="10000000000",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Goku Super Sayajin Blue",img_character="http://vignette1.wikia.nocookie.net/dragonball/images/1/12/SSGSS_GOKU.png/revision/latest?cb=20151025084338",fighting_power="100000000000",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Little Goku",img_character="https://i.stack.imgur.com/6HrTE.jpg",fighting_power="10000000",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Little Goku Super Saiyan 1",img_character="https://static.comicvine.com/uploads/original/14/149746/3647183-4101411823-Goku_.jpg",fighting_power="150000000",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Little Goku Super Sayajin 2",img_character="http://vignette2.wikia.nocookie.net/dragonball/images/7/7f/GT_Kid_Goku_Super_Saiyan_2_by_dbzataricommunity.jpg/revision/latest?cb=20110412181525",fighting_power="6000000000",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Little Goku Super Sayajin 3",img_character="http://pm1.narvii.com/6152/0abf4a01f38c1f84e7ea32e9601aaa1575b93e7e_hq.jpg",fighting_power="10000000000",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Goku Super Sayajin 4",img_character="http://vignette4.wikia.nocookie.net/p__/images/f/f1/Goku_Super_Saiyan_4.png/revision/latest?cb=20130805024507&path-prefix=protagonist",fighting_power="100000000000",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Vegeta",img_character="",fighting_power="",type_character=2,saga=2)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin 1",img_character="",fighting_power="",type_character=2,saga=2)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin 2",img_character="",fighting_power="",type_character=2,saga=2)
    p.save()
    p = character(nm_character="Vegeta",img_character="",fighting_power="",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin 1",img_character="",fighting_power="",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin 2",img_character="",fighting_power="",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin 4",img_character="",fighting_power="",type_character=2,saga=3)
    p.save()
    p = character(nm_character="Vegeta",img_character="",fighting_power="",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin 1",img_character="",fighting_power="",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin 2",img_character="",fighting_power="",type_character=2,saga=4)
    p.save()
    p = character(nm_character="Vegeta Super Sayajin Blue",img_character="",fighting_power="",type_character=2,saga=4)
    p.save()
